    ...
    <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
            <div className="flex flex-col items-center lg:items-start">
                ...
                bg-clip-text text-4xl tracking-tight text-transparent">Blockchain Developer</span>
        ...
        <div className="flex justify-center">
            <img src={profilePic} alt="Ayush Nayak" style={{ width: '500px', height: 'auto',marginLeft: '20px' }}/>
        </div>
        </div>
    </div>
  </div>
